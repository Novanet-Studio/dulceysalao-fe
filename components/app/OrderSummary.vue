...
.order-summary__title {
  @apply font-medium mb-3 text-color-8 text-sm lg:text-base;
}

.order-summary__content {
  @apply px-6 py-8 mb-3 bg-color-2 rounded-sm shadow-md;
}
...
.order-summary__strong-text {
  @apply text-color-8 font-medium;
}
